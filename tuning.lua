...
function Tune(overrides)
    ...
    local multiplayer_armor_durability_modifier = 2
    ...
    TUNING =
    {
        ...
        {
            DEFAULT = 34,
            RIDER = 25 * multiplayer_attack_modifier,
            ORNERY = 50 * multiplayer_attack_modifier,
            PUDGY = 20 * multiplayer_attack_modifier,
        },
...
--[[
		...
		DUMBBELL_THROWN_CONSUMPTION_MULT = 0,
